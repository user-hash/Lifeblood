...
L-LIM-001 (preprocessor-guarded callsites invisible to `find_references` / `dependants`) **CLOSED** with live DAWG verification under the 5-wave Wave 6 chain (`43c1499` → `dd157af`):
