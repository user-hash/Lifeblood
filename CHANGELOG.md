...
### Wave 6.F: L-LIM-001 closure (implementation complete, live re-probe pending dist swap) (2026-05-24)

L-LIM-001 (preprocessor-guarded callsites invisible to `find_references` / `dependants`) **CLOSED in-tree** under the 5-wave Wave 6 chain (`43c1499` → `d443550`):
