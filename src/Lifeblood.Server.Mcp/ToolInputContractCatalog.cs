...
public static class ToolInputContractCatalog
{
    ...
    private static IEnumerable<ToolInputContract> Create()
    {
        ...
        yield return Contract(@"lifeblood_performance_evidence",
            ...
            Arg(@"sourcePath", ToolArgumentType.String, required: true, arrayItemType: null, description: @"Generic JSON/CSV or structural Unity ProfilerRecorder receipt inside the analyzed workspace. Relative paths resolve from workspace root.", enumValues: Array.Empty<string>()),
