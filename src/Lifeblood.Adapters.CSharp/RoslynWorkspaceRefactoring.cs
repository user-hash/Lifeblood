...
public sealed class RoslynWorkspaceRefactoring : IWorkspaceRefactoring, IDisposable
{
    ...
    public TextEdit[] Rename(string symbolId, string newName)
    {
        ...
        // ResolveSymbol triggers EnsureWorkspace. INV-RENAME-CROSS-PARTIAL-001.
...
#pragma warning restore CS0618
        ...
        // INV-RENAME-POINT-EDITS-001. Document.GetTextChangesAsync, NOT
        // SourceText.GetTextChanges (which brute-diffs cross-container).
