...
public class NativeClangExecutableRatchetTests
{
    ...
    public void Executable_DirectRefsFixture_EmitsEnumTypedefAndGlobalFacts()
    {
        ...
        AssertFileReferenceKindInventory(
            ...
            outgoingParameterTypes: 1,
            incomingParameterTypes: 0);
        AssertFileReferenceKindInventory(
            graph,
            "file:src/packet.h",
            outgoingCallbackTargets: 0,
            ...
            outgoingParameterTypes: 0,
            incomingParameterTypes: 1);
        ...
        AssertFieldAccessCounts(graph, "field:Packet.kind", incoming: 1, outgoing: 0);
        ...
        int parameterTypes = 0)
    {
        ...
        Assert.Equal(parameterTypes.ToString(), module.Properties["native.parameterTypeEdgeCount"]);
    }
    ...
    private static void AssertFileReferenceKindInventory(
        ...
        int outgoingParameterTypes = 0,
        int incomingParameterTypes = 0)
    {
        var file = graph.GetSymbol(fileId);
        Assert.NotNull(file);
        Assert.Equal(
        ...
        Assert.Equal(
            outgoingParameterTypes.ToString(),
            file.Properties["native.fileOutgoingParameterTypeEdgeCount"]);
        Assert.Equal(
            incomingParameterTypes.ToString(),
        ...
        int incomingCrossFileCalls = 0)
    {
        ...
        Assert.True(file.Properties.ContainsKey("native.fileOutgoingParameterTypeEdgeCount"));
        Assert.True(file.Properties.ContainsKey("native.fileIncomingParameterTypeEdgeCount"));
    ...
    private static void AssertFieldAccessCounts(
        SemanticGraph graph,
        string symbolId,
        int incoming,
        int outgoing)
    {
        ...
        Assert.Equal(
            incoming.ToString(),
            symbol!.Properties.GetValueOrDefault("native.fieldAccessInCount", "0"));
        Assert.Equal(
            outgoing.ToString(),
    ...
    private static void AssertEnumMemberCounts(
        SemanticGraph graph,
        string symbolId,
        int incoming,
        int outgoing)
    {
        ...
        Assert.Equal(
            incoming.ToString(),
            symbol!.Properties.GetValueOrDefault("native.enumMemberInCount", "0"));
        Assert.Equal(
            outgoing.ToString(),
    ...
    private static void AssertUnderlyingTypeCounts(
        SemanticGraph graph,
        string symbolId,
        int incoming,
        int outgoing)
    {
        ...
        Assert.Equal(
            incoming.ToString(),
            symbol!.Properties.GetValueOrDefault("native.underlyingTypeInCount", "0"));
        Assert.Equal(
            outgoing.ToString(),
