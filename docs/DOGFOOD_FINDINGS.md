...
Tests 1011 → **1,098 (+87)**, zero skipped. Invariants 101 → **122 (+21)** across 63 → **83 categories (+20)**. Symbols 3,278 → **3,507 (+229)**. Edges 16,973 → **21,115 (+4,142, +24%)** — the bulk of the edge growth is F1d closing the bare-identifier property/event-read gap on Lifeblood self. Types 350 → 363.
