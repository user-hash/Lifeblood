...
totalCount    : 87
categories    : 50  (RESOLVER, BCL, STREAM, ADAPT, GRAPH, ANALYSIS, COMPFACT, USAGE, USAGE-PORT, USAGE-PROBE, FILE-EDGE, ANALYZE-FALLBACK, EXTRACT-ENUMMEMBER, SEARCH-MATCHKIND, JSON-IMPORT-BOM, MCP-STDIO-UTF8, EDGE-CALLSITE, INCREMENTAL-XREF, RESOLVE-MEMBER, BLAST-RADIUS-GROUP, DEADCODE-TRIAGE, DIAGNOSTIC-ENVELOPE-DEFINES, CYCLE-TAXONOMY, ENUM-COVERAGE, TEST-IMPACT, PATHBUCKET-SHARED, …)
duplicates    : 0
parseWarnings : 0
sourcePaths   : [
