...
cost policy, exact value-domain/conversion policy, and reasoned suppressions through one stateless
...
record contributes only exact value origins and nested operators.
