...
<!-- portCount: 33 --><!-- testCount: 1678 --><!-- toolCount: 42 --><!-- invariantCount: 218 --><!-- invariantCategoryCount: 163 --><!-- skippableFactCount: 53 --><!-- selfAnalyzeSymbols: 7704 --><!-- selfAnalyzeEdges: 40661 --><!-- selfAnalyzeModules: 12 --><!-- selfAnalyzeTypes: 829 --><!-- staticTablesDefaultMaxRows: 32 --><!-- staticTablesDefaultMaxTables: 64 -->

The current in-tree changed-set, profile-query, diagnostic-ownership,
evidence-drift, compact-invariant, retained-memory, temporal-contract, and contract-call-route atoms are repository-verified by 1,678
test cases (1,667 pass, 11 native-clang environment skips) and 218 typed
