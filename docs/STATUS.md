...
<!-- portCount: 33 --><!-- testCount: 1687 --><!-- toolCount: 42 --><!-- invariantCount: 218 --><!-- invariantCategoryCount: 163 --><!-- skippableFactCount: 53 --><!-- selfAnalyzeSymbols: 7839 --><!-- selfAnalyzeEdges: 41598 --><!-- selfAnalyzeModules: 12 --><!-- selfAnalyzeTypes: 841 --><!-- staticTablesDefaultMaxRows: 32 --><!-- staticTablesDefaultMaxTables: 64 -->

The current in-tree changed-set, profile-query, diagnostic-ownership,
evidence-drift, compact-invariant, retained-memory, temporal-contract, contract-call-route, and contract-state atoms are repository-verified by 1,687
test cases (1,676 pass, 11 native-clang environment skips) and 218 typed
