...
<!-- portCount: 33 --><!-- testCount: 1672 --><!-- toolCount: 42 --><!-- invariantCount: 218 --><!-- invariantCategoryCount: 163 --><!-- skippableFactCount: 53 --><!-- selfAnalyzeSymbols: 7631 --><!-- selfAnalyzeEdges: 40232 --><!-- selfAnalyzeModules: 12 --><!-- selfAnalyzeTypes: 821 --><!-- staticTablesDefaultMaxRows: 32 --><!-- staticTablesDefaultMaxTables: 64 -->

The current in-tree changed-set, profile-query, diagnostic-ownership,
evidence-drift, compact-invariant, retained-memory, and temporal-contract atoms are repository-verified by 1,672
test cases (1,661 pass, 11 native-clang environment skips) and 218 typed
