...
| Lifeblood.Server.Mcp | MCP server with **30 tools** over stdio (17 read-side + 13 write-side). Bidirectional Roslyn. `RoslynSemanticView` constructed once per `GraphSession.Load` and shared by reference across consumers. `ToolDefinition.EnvelopeClassification` is the registry-side source of truth for the truth envelope. McpDispatcher owns the wire protocol; Program.cs is a thin stdio I/O loop. |
...
totalCount    : 101
categories    : 63  (RESOLVER, BCL, STREAM, ADAPT, GRAPH, ANALYSIS, COMPFACT, CONN, MCP, VIEW, APP, DOMAIN, TEST, UNITY, USAGE, USAGE-PORT, USAGE-PROBE, ANALYZE-FALLBACK, ANALYZE-SKIPPED-PROMINENCE, AUTHORITY, BLAST-RADIUS-GROUP, CANONICAL, CHANGELOG, COMPROOT, CYCLE-TAXONOMY, DEADCODE, DEADCODE-TRIAGE, DIAGNOSTIC-ENVELOPE-DEFINES, DIAGNOSTIC-IVT-PARITY, DIAGNOSTIC-MSBUILD-IMPLICIT-NOWARN, DIAGNOSTIC-NUGET-BINDING-PARITY, DIAGNOSTIC-PARITY, DOCS, EDGE-CALLSITE, ENUM-COVERAGE, ENVELOPE, EXECUTE, EXTRACT-DISPATCH-TABLE-COVERAGE, EXTRACT-ENUMMEMBER, EXTRACT-METHOD-GROUP-CANDIDATE, EXTRACT-METHOD-ORIGINAL-DEFINITION, EXTRACT-STATIC-IMPLICIT-ARRAY, EXTRACT-STATIC-TABLES, EXTRACT-SYNTHESIZED-CTOR, FILE-EDGE, FINDIMPL, FLAG-COVERAGE-COMPOSITION, FORWARDER, INCR, INCREMENTAL-XREF, INVARIANT, JSON-IMPORT-BOM, MCP-STDIO-UTF8, METHOD-FLAG-SUMMARY, MODULE-REFS, PATHBUCKET-SHARED, PIPE, RESOLVE-MEMBER, SCRIPTHOST, SEARCH-MATCHKIND, TEST-IMPACT, TESTDISC, TOOLREG, WIRE-CONTRACT)
duplicates    : 0
parseWarnings : 0
sourcePaths   : [
