...
cadence boundaries, multi-input/result/control operation shapes, request-local
constant/source uniqueness, and reasoned suppressions through one stateless
...
static-table rows remain owned by their existing tools.
